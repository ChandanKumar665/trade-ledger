...
export async function getAccountList(input) {
    try {
        const { user_id } = input
        const HOST = `${process.env.REACT_APP_API_URL}/api/v1/account/list`
...
export async function create(input) {
    try {
        ...
        const HOST = `${process.env.REACT_APP_API_URL}/api/v1/account`
...
export async function update(input) {
    try {
        ...
        const HOST = `${process.env.REACT_APP_API_URL}/api/v1/account/update`
...
export async function deleteAccount(input) {
    try {
        ...
        const HOST = `${process.env.REACT_APP_API_URL}/api/v1/account/remove`
